...
call "%VIV_BIN%\xvlog.bat" -work xil_defaultlib ..\..\rtl\crc32_8b.v ..\..\rtl\checksum16.v ..\..\rtl\fifo_sync.v ..\..\rtl\frame_fifo.v ..\..\rtl\mac_rx_64.v ..\..\rtl\mac_tx_64.v ..\..\rtl\tcp_cam.v ..\..\rtl\tcb.v ..\..\rtl\tcp_rx.v ..\..\rtl\tcp_echo.v ..\..\rtl\axis_pipe.v ..\..\rtl\tcp_tx_frame.v ..\..\rtl\retx_ram.v ..\..\rtl\tcp_synp.v ..\..\tb\tb_tcp_echo.v
if errorlevel 1 exit /b 1
call "%VIV_BIN%\xvlog.bat" -work xil_defaultlib "%VIV_BIN%\..\..\data\verilog\src\glbl.v"

call "%VIV_BIN%\xelab.bat" -debug typical -timescale 1ns/1ps -L unisims_ver -L xil_defaultlib xil_defaultlib.tb_tcp_echo xil_defaultlib.glbl -s tb_tcp_echo
if errorlevel 1 exit /b 1
