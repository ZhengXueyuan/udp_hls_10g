...
call "%VIV_BIN%\xvlog.bat" -work xil_defaultlib ..\..\rtl\crc32_8b.v ..\..\rtl\checksum16.v ..\..\rtl\fifo_sync.v ..\..\rtl\frame_fifo.v ..\..\rtl\mac_rx_64.v ..\..\rtl\mac_tx_64.v ..\..\rtl\tcp_cam.v ..\..\rtl\tcb.v ..\..\rtl\tcp_rx.v ..\..\rtl\tcp_echo.v ..\..\rtl\tcp_tx_frame.v ..\..\rtl\retx_ram.v ..\..\rtl\tcp_synp.v ..\..\tb\tb_tcp_echo.v
if errorlevel 1 exit /b 1
