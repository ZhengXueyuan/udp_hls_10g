#=============================================================================
# route_check.tcl — P5e-T1 私有门: 把 board/timing_p5.tcl (synth+place) 延长到
#   route_design, 取**布线后**的 WNS/WHS (place-only 的 hold 数偏悲观:
#   基线 place-only WHS=-0.159/718 端点, 而布线后为 +0.035)。
# 与 board/timing_p5.tcl 的差异: ① 工程名 p5r_prj (不覆盖 p5t_prj 产物)
...
puts "\n===== P5e-T1 ROUTED TIMING SUMMARY: ${root_dir}/vivado_prj/timing_p5_routed.rpt ====="
exit
