...
//
// 捕获 (resp_p5_baseline.memh): 每拍 "%02h %d" (gmii_txd, tx_en) + 事件行
...
// (resp_p5_baseline_close.memh), 默认路径逐字不变:
...
`ifdef P5_CLOSE
    ...
    task close_main;
        begin
            ...
            fd = $fopen("resp_p5_baseline_close.memh", "w");
            #200; rst_n = 1;
...
`else
        fd = $fopen("resp_p5_baseline.memh", "w");
`endif
        cfg_tdata = 32'd0; cfg_tvalid = 1'b0;
        ac_addr = 8'h00; ac_wr = 1'b0; ac_wdata = 32'd0;
        #200; rst_n = 1;
