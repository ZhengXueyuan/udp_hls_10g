...
C:\AMDDesignTools\2025.2\Vitis\bin\vitis-run.bat --mode hls --tcl --part xc7k325tffg676-2 --freqhz 125000000 csim_d6_ac0.tcl > csim_d6_ac0_stdout.log 2>&1
type csim_d6_ac0_stdout.log
exit /b %ERRORLEVEL%
